...
const SearchInput = () => {
    ...
    const handleSubmit = (e) => {
        ...
        //search logic - ignore case and select if user exists
    ...
    return (
        <form onSubmit={handleSubmit} className='flex items-center gap-2 p-3 mt-1'>
...
// const SearchInput = () => {
//     return (
//         <form className='flex items-center gap-2 p-3 mt-1'>
